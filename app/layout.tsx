    ...
    <html lang="en">
      <body className={`${inter.className} bg-gray-900 text-white`}>
        <div className="flex h-full min-h-screen w-full flex-col justify-between">
          <Header />
          <main className="mx-auto w-full max-w-5xl flex-auto px-4 py-8 sm:px-8 md:py-12 bg-gradient-to-b from-gray-800 via-gray-900 to-black shadow-lg rounded-lg">
            {children}
          </main>
          <SpeedInsights />
          <Footer />
